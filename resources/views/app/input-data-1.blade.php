<x-layout>
    <div class="max-w-7xl">
        ...
        <div class="grid grid-cols-3 gap-4 space-y-8">
            ...
            <div>
                <form action="" method="POST">
                    ...
                    <div
                        class="bg-white rounded-xl shadow-md p-8 bg-gradient-to-b from-[#E1F1FE] via-[#FAFCFF] to-[#FFFF]">
