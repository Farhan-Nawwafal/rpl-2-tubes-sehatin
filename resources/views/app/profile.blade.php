<x-layout>
    {{--
        ...
        Nanti kalau Backend sudah siap, hapus blok @php ini dan ganti $user dengan auth()->user()
    --}}
    @php
        ...
        <template x-if="showChangePassword">
            <div>
                ...
                <div class="bg-white p-6 rounded-lg shadow bg-gradient-to-b from-[#E1F1FE] via-[#FFFFF] to-[#FFFF]">
                    ...
                    {{-- Form Dummy (Action # karena belum ada route) --}}
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <div class="flex gap-4 mt-6">
                            ...
                            <button type="button" {{-- Type button biar ga reload halaman pas dummy --}}
                        ...
                        <div class="flex flex-col text-gray-700 space-y-4 items-start pl-10 pr-10">
                            <div>
                                ...
                                <div class="font-medium">
                                    {{ $user->age ?? 'Not set' }} Tahun
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm text-gray-500 mb-1">Jenis Kelamin</label>
                                <div class="font-medium">
                                    {{-- Logic sederhana untuk display jenis kelamin --}}
                                    @if ($user->sex == 'L')
                                        Laki-Laki
                                    @elseif($user->sex == 'W')
                                        Wanita
